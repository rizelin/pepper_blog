...
<body>
  ...
  <div class="pepper_header">
      <a <?=(isset($_SESSION['user']))?"href='../require/main.php'" : ''?> ><h1 class="pepper_title">Pepper アトリエサテライト甲府</h1></a>
      <?if (isset($main)) {?>
        <dl class="navi_bar">
      ...
      <?}else{?>
        <dl class="navi_bar2">
            <dt><img src="../../common/img/menuBtn1.png" alt="home"><a <?=(isset($_SESSION['user']))?"href='../atorie/atorie.php'" : ''?> >紹介</a></dt>
            <dt><img src="../../common/img/menuBtn2.png" alt="information"><a <?=(isset($_SESSION['user']))?"href='../information/informationBoard.php'" : ''?> >お知らせ</a></dt>
            <dt><img src="../../common/img/menuBtn3.png" alt="blog"><a <?=(isset($_SESSION['user']))?"href='../blog/blogBoard.php'" : ''?> >Blog</a></dt>
            <dt><img src="../../common/img/menuBtn4.png" alt="schedule"><a <?=(isset($_SESSION['user']))?"href='../schedule/scheduleBoard.php'" : ''?> >スケジュール</a></dt>
        </dl>
      <?} ?>
      <?if(isset($_SESSION['user'])){?>
        <p><a id="logout" href="../index.php?logout">ログアウト</a></p>
      <? }?>
  </div>

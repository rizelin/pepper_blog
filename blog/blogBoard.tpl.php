...
<section class="blog_page">
  <p class="sub_navi clearfix"><a href="../require/main.php">TOP</a> ≫ Blog</p>
            ...
            <tr>
                <td>
                    <?if (!empty($blogList[$i]['img'])){?>
                        <div class="blog_list_img" style="background-image:url('../common/media/blog/<?=$blogList[$i]['img']?>')"></div>
                    <?}else {?>
                        <div class="blog_list_img" style="background-image:url('../common/img/noImage.png')"></div>
                    <?}?>
                </td>
                <td>
